...
namespace FIND_SUHAIL
{
    public partial class leaderboard : UserControl
    {
        ...
        {
            //menu mainForm = (menu)this.FindForm();
            // Ambil form induknya secara umum tanpa memaksa jadi 'menu'
            Form parentForm = this.FindForm();

            if (parentForm != null)
            {
                // Kalau ternyata dibuka dari form menu
                if (parentForm is menu mainForm)
                {
                    // Tulis kode khusus menu di sini jika ada (kalau tidak ada, biarkan kosong)
                }
                // Kalau ternyata dibuka dari form hasilg
                else if (parentForm is hasilg hasilForm)
                {
                    // Tulis kode khusus hasilg di sini jika ada (kalau tidak ada, biarkan kosong)
                }
            }
        }
